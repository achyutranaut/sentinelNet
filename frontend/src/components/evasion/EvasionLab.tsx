    ...
    >
      ...
      <div className="bg-[#161b22] border-b border-[#21262d] px-2.5 py-1.5 flex justify-between items-center font-heading text-[10px] font-bold tracking-wider uppercase text-[#8b949e] select-none">
        ...
        <div className="flex items-center gap-2 font-mono text-[9px]">
          ...
          {isLoading && <span className="w-1.5 h-1.5 bg-[#D29922] rounded-full animate-ping" />}
        </div>
      </div>
      ...
      <div className="flex-1 p-2.5 flex flex-col gap-2">
        ...
        <div className="bg-[#161b22] border border-[#21262d] rounded-[2px] p-2 flex items-center gap-3">
          <div className="flex items-center gap-1.5 font-heading text-[10px] font-bold text-[#8b949e] uppercase whitespace-nowrap">
            <Sliders className="w-3.5 h-3.5 text-[#e6edf3]" />
          ...
          <span className="font-mono text-xs font-semibold text-[#e6edf3] w-12 text-right">
        ...
        <div className="flex-1 flex gap-2">
          {/* SVG Chart Area */}
          <div className="flex-[2] bg-[#090b0e] border border-[#21262d] rounded-[2px] p-1 relative flex items-center justify-center">
            <svg viewBox="0 0 380 230" className="w-full h-full select-none">
              {/* Grid & Axes */}
              <line x1="40" y1="20" x2="40" y2="190" stroke="#21262d" strokeWidth="1" />
              <line x1="40" y1="190" x2="360" y2="190" stroke="#21262d" strokeWidth="1" />

              {/* Y Axis Ticks */}
              <text x="32" y="24" className="fill-[#8b949e] font-mono text-[8px]" textAnchor="end">1.0</text>
              <text x="32" y="105" className="fill-[#8b949e] font-mono text-[8px]" textAnchor="end">0.5</text>
              <text x="32" y="193" className="fill-[#8b949e] font-mono text-[8px]" textAnchor="end">0.0</text>

              {/* X Axis Ticks */}
              <text x="40" y="204" className="fill-[#8b949e] font-mono text-[8px]" textAnchor="middle">0.0</text>
              <text x="120" y="204" className="fill-[#8b949e] font-mono text-[8px]" textAnchor="middle">0.1</text>
              <text x="200" y="204" className="fill-[#8b949e] font-mono text-[8px]" textAnchor="middle">0.2</text>
              <text x="280" y="204" className="fill-[#8b949e] font-mono text-[8px]" textAnchor="middle">0.3</text>
              <text x="360" y="204" className="fill-[#8b949e] font-mono text-[8px]" textAnchor="middle">0.4</text>
              <text x="200" y="220" className="fill-[#8b949e] font-mono text-[8.5px] uppercase" textAnchor="middle">
                Perturbation Budget (ε)
              </text>

              {/* Curves */}
              <path d={dSup} fill="none" stroke="#F85149" strokeWidth="1.5" strokeDasharray="4 3" />
              <path d={dAe} fill="none" stroke="#3b82f6" strokeWidth="1.5" strokeDasharray="2 2" />
              <path d={dComb} fill="none" stroke="#3FB950" strokeWidth="1.8" />
              ...
              <line
                ...
                strokeDasharray="3 3"
              />
              <circle id="dot-combined" r="4" fill="#3FB950" cx={targetCursorX} cy={targetCombY} />
              <circle id="dot-supervised" r="3.5" fill="#F85149" cx={targetCursorX} cy={targetSupY} />
            </svg>
          </div>

          {/* Telemetry Column */}
          <div className="flex-1 bg-[#161b22] border border-[#21262d] rounded-[2px] p-2.5 flex flex-col justify-between font-mono select-none">
            <div className="space-y-2">
              <div>
                <div className="text-[9px] uppercase text-[#8b949e] font-heading">Perturbation Budget</div>
                <div className="text-sm font-bold text-[#e6edf3]">{currentEpsilon.toFixed(2)}</div>
              </div>

              <div>
                <div className="text-[9px] uppercase text-[#8b949e] font-heading">Signature Recall (Tier 1)</div>
              ...
              <div>
                <div className="text-[9px] uppercase text-[#8b949e] font-heading">Zero-Day Anomaly (Tier 2)</div>
              ...
              <div>
                <div className="text-[9px] uppercase text-[#8b949e] font-heading">Multi-Tier Defense</div>
